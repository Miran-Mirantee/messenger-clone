...
describe("get price range function", () => {
  ...
  it("should return the correct price value #3", () => {
    expect(getAccessibilityRange("3").minAccessibility).toMatch("0.8");
    expect(getAccessibilityRange("3").maxAccessibility).toMatch("1.0");
  });

  it("should return the correct price value #4", () => {
    expect(getAccessibilityRange().minAccessibility.length).toBe(0);
    expect(getAccessibilityRange().maxAccessibility.length).toBe(0);
  });
});
